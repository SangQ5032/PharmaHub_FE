...
const WORK_SCHEDULE_ITEMS: WorkScheduleItem[] = [
  {
    id: 'work-1',
    name: 'Lịch Làm Việc',
    icon: 'calendar',
...
const BranchWorkScheduleHubScreen = () => {
  const navigation = useNavigation();

  const renderWorkScheduleCard = ({ item }: { item: WorkScheduleItem }) => (
    <TouchableOpacity
      style={styles.card}
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <FlatList
          data={WORK_SCHEDULE_ITEMS}
          renderItem={renderWorkScheduleCard}
...
export default BranchWorkScheduleHubScreen;
