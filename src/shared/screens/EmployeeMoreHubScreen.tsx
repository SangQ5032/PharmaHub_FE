...
const EMPLOYEE_MORE_OPTION_IDS = new Set(['staff-7', 'staff-8']);

const EmployeeMoreHubScreen: React.FC = () => {
  ...
  const options = React.useMemo(() => {
    return roleConfig.options.filter(o => EMPLOYEE_MORE_OPTION_IDS.has(o.id));
  }, [roleConfig.options]);
...
export default EmployeeMoreHubScreen;
